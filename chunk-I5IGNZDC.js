import{o as k,p as ae}from"./chunk-AT3MKFJ3.js";import{Gb as v,Hb as C,Ja as ne,Lb as oe,S as Z,U as $,a as X,fa as ee,r as J,tb as ie,v as F,w as D,za as te}from"./chunk-GCMU57WK.js";import{Ea as m,Fa as n,Ga as t,Ha as l,I as z,L as A,Mb as T,Mc as j,Nc as H,O as b,Oa as V,Oc as G,P as E,Pa as s,Pc as U,Qc as K,Ra as M,bb as _,cb as e,cd as Q,eb as g,ed as Y,gb as y,gd as q,ha as p,hb as P,ib as w,ma as N,oa as c,pa as L,rb as B,ya as W,za as R}from"./chunk-XD3NZLB4.js";import{a as x,b as f}from"./chunk-GAL4ENT6.js";var le=(()=>{class o{onClick(){alert("Po Button!")}static \u0275fac=function(a){return new(a||o)};static \u0275cmp=c({type:o,selectors:[["sample-po-button-basic"]],standalone:!1,decls:1,vars:0,consts:[["p-label","PO Button",3,"p-click"]],template:function(a,i){a&1&&(n(0,"po-button",0),s("p-click",function(){return i.onClick()}),t())},dependencies:[D],encapsulation:2})}return o})();var he=o=>({"docs-sample-code-tabs":o}),de=(()=>{class o{hideSampleCodeTabs=!0;sampleCodeButtonLabel="Talk is cheap, show me the code!";sampleCodeButtonIcon="an an-plus";toggleSampleCodeTabs(){this.hideSampleCodeTabs=!this.hideSampleCodeTabs,this.sampleCodeButtonLabel=this.hideSampleCodeTabs?"Talk is cheap, show me the code!":"Okay, hide the code",this.sampleCodeButtonIcon=this.hideSampleCodeTabs?"an an-plus":"an an-minus"}static \u0275fac=function(a){return new(a||o)};static \u0275cmp=c({type:o,selectors:[["sample-po-button-basic-view"]],standalone:!1,decls:24,vars:6,consts:[[1,"sample-blockquote"],[1,"sample-title","po-font-text-large-bold"],[1,"show-me-the-code",3,"click"],[3,"ngClass"],["p-size","2"],["p-label","HTML","p-active",""],[1,"doc-label-path"],["appCodeHighlight","",1,"html"],["p-label","TS"],["appCodeHighlight","",1,"typescript"],[1,"docs-sample-container"]],template:function(a,i){a&1&&(l(0,"br"),n(1,"blockquote",0)(2,"label",1),e(3,"PO Button Basic"),t(),n(4,"a",2),s("click",function(){return i.toggleSampleCodeTabs()}),l(5,"span"),e(6),t()(),n(7,"div",3)(8,"po-tabs",4)(9,"po-tab",5)(10,"div")(11,"label",6),e(12,"sample-po-button-basic/sample-po-button-basic.component.html"),t(),n(13,"pre",7),e(14,`<po-button p-label="PO Button" (p-click)="onClick()"> </po-button>
...
`),t()()()()(),n(21,"div",10),l(22,"sample-po-button-basic"),t(),l(23,"hr")),a&2&&(p(5),_("po-icon "+i.sampleCodeButtonIcon),p(),g(" ",i.sampleCodeButtonLabel),p(),m("ngClass",B(4,he,i.hideSampleCodeTabs)))},dependencies:[T,k,v,C,le],encapsulation:2})}return o})();var pe=(()=>{class o{poDialog=A(ee);label;kind;icon;size;properties;type;propertiesOptions=[{value:"disabled",label:"Disabled"},{value:"loading",label:"Loading"},{value:"danger",label:"Danger"}];iconsOptions=[{label:"an an-newspaper",value:"an an-newspaper"},{label:"an an-calendar-dots",value:"an an-calendar-dots"},{label:"an an-user",value:"an an-user"},{label:"fa fa-podcast",value:"fa fa-podcast"}];kindsOptions=[{label:"primary",value:"primary"},{label:"secondary",value:"secondary"},{label:"tertiary",value:"tertiary"}];sizesOptions=[{label:"small",value:"small"},{label:"medium",value:"medium"},{label:"large",value:"large"}];typeOptions=[{label:"button",value:F.Button},{label:"submit",value:F.Submit},{label:"reset",value:F.Reset}];ngOnInit(){this.restore()}buttonClick(){this.poDialog.alert({title:"PO Button",message:"Hello PO World!!!"})}propertiesChange(r){this.kindsOptions[2]=f(x({},this.kindsOptions[2]),{disabled:!1}),this.sizesOptions[0]=f(x({},this.sizesOptions[0]),{disabled:!1}),this.sizesOptions[1]=f(x({},this.sizesOptions[1]),{disabled:!1}),r&&r.forEach(a=>{a==="danger"&&this.properties.includes("danger")&&(this.kindsOptions[2]=f(x({},this.kindsOptions[2]),{disabled:!0}))})}verifyDisabled(r){let a=[...this.propertiesOptions];r==="tertiary"?(a[2]={value:"danger",label:"Danger",disabled:!0},this.propertiesOptions=a):(a[2]={value:"danger",label:"Danger",disabled:!1},this.propertiesOptions=a)}restore(){this.label=void 0,this.kind="secondary",this.size="medium",this.icon=void 0,this.type=F.Button,this.properties=[],this.kindsOptions[2]=f(x({},this.kindsOptions[2]),{disabled:!1}),this.sizesOptions[0]=f(x({},this.sizesOptions[0]),{disabled:!1}),this.sizesOptions[1]=f(x({},this.sizesOptions[1]),{disabled:!1})}static \u0275fac=function(a){return new(a||o)};static \u0275cmp=c({type:o,selectors:[["sample-po-button-labs"]],standalone:!1,decls:14,vars:19,consts:[["f","ngForm"],[1,"po-row"],[1,"po-sm-12",3,"p-click","p-disabled","p-icon","p-label","p-loading","p-size","p-danger","p-kind","p-type"],["name","label","p-clean","","p-label","Label",1,"po-lg-6","po-md-6",3,"ngModelChange","ngModel"],["name","properties","p-columns","4","p-label","Properties",1,"po-lg-12",3,"ngModelChange","p-change","ngModel","p-options"],["name","icon","p-columns","4","p-label","Icon",1,"po-lg-12",3,"ngModelChange","ngModel","p-options"],["name","kind","p-columns","4","p-label","Kind",1,"po-lg-12",3,"ngModelChange","p-change","ngModel","p-options"],["name","type","p-columns","4","p-label","Type",1,"po-lg-12",3,"ngModelChange","ngModel","p-options"],["name","size","p-columns","4","p-label","Size","p-help","Para aplicar o tamanho small, configure o n\xEDvel de acessibilidade para AA, ajust\xE1vel no navbar ou servi\xE7o de tema (https://po-ui.io/documentation/po-theme).",1,"po-lg-12",3,"ngModelChange","p-change","ngModel","p-options"],["p-label","Sample Restore",1,"po-lg-3","po-md-6",3,"p-click"]],template:function(a,i){if(a&1){let u=V();n(0,"div",1)(1,"po-button",2),s("p-click",function(){return i.buttonClick()}),t()(),l(2,"po-divider"),n(3,"form",null,0)(5,"div",1)(6,"po-input",3),w("ngModelChange",function(d){return b(u),P(i.label,d)||(i.label=d),E(d)}),t()(),n(7,"po-checkbox-group",4),w("ngModelChange",function(d){return b(u),P(i.properties,d)||(i.properties=d),E(d)}),s("p-change",function(d){return i.propertiesChange(d)}),t(),n(8,"po-radio-group",5),w("ngModelChange",function(d){return b(u),P(i.icon,d)||(i.icon=d),E(d)}),t(),n(9,"po-radio-group",6),w("ngModelChange",function(d){return b(u),P(i.kind,d)||(i.kind=d),E(d)}),s("p-change",function(d){return i.verifyDisabled(d)}),t(),n(10,"po-radio-group",7),w("ngModelChange",function(d){return b(u),P(i.type,d)||(i.type=d),E(d)}),t(),n(11,"po-radio-group",8),w("ngModelChange",function(d){return b(u),P(i.size,d)||(i.size=d),E(d)}),s("p-change",function(d){return i.verifyDisabled(d)}),t(),n(12,"div",1)(13,"po-button",9),s("p-click",function(){return i.restore()}),t()()()}a&2&&(p(),m("p-disabled",i.properties.includes("disabled"))("p-icon",i.icon)("p-label",i.label)("p-loading",i.properties.includes("loading"))("p-size",i.size)("p-danger",i.properties.includes("danger"))("p-kind",i.kind)("p-type",i.type),p(5),y("ngModel",i.label),p(),y("ngModel",i.properties),m("p-options",i.propertiesOptions),p(),y("ngModel",i.icon),m("p-options",i.iconsOptions),p(),y("ngModel",i.kind),m("p-options",i.kindsOptions),p(),y("ngModel",i.type),m("p-options",i.typeOptions),p(),y("ngModel",i.size),m("p-options",i.sizesOptions))},dependencies:[K,j,H,U,G,D,X,Z,$,ne],encapsulation:2})}return o})();var ve=o=>({"docs-sample-code-tabs":o}),se=(()=>{class o{hideSampleCodeTabs=!0;sampleCodeButtonLabel="Talk is cheap, show me the code!";sampleCodeButtonIcon="an an-plus";toggleSampleCodeTabs(){this.hideSampleCodeTabs=!this.hideSampleCodeTabs,this.sampleCodeButtonLabel=this.hideSampleCodeTabs?"Talk is cheap, show me the code!":"Okay, hide the code",this.sampleCodeButtonIcon=this.hideSampleCodeTabs?"an an-plus":"an an-minus"}static \u0275fac=function(a){return new(a||o)};static \u0275cmp=c({type:o,selectors:[["sample-po-button-labs-view"]],standalone:!1,decls:24,vars:6,consts:[[1,"sample-blockquote"],[1,"sample-title","po-font-text-large-bold"],[1,"show-me-the-code",3,"click"],[3,"ngClass"],["p-size","2"],["p-label","HTML","p-active",""],[1,"doc-label-path"],["appCodeHighlight","",1,"html"],["p-label","TS"],["appCodeHighlight","",1,"typescript"],[1,"docs-sample-container"]],template:function(a,i){a&1&&(l(0,"br"),n(1,"blockquote",0)(2,"label",1),e(3,"PO Button Labs"),t(),n(4,"a",2),s("click",function(){return i.toggleSampleCodeTabs()}),l(5,"span"),e(6),t()(),n(7,"div",3)(8,"po-tabs",4)(9,"po-tab",5)(10,"div")(11,"label",6),e(12,"sample-po-button-labs/sample-po-button-labs.component.html"),t(),n(13,"pre",7),e(14,`<div class="po-row">
  <po-button
    class="po-sm-12"
...
`),t()()()()(),n(21,"div",10),l(22,"sample-po-button-labs"),t(),l(23,"hr")),a&2&&(p(5),_("po-icon "+i.sampleCodeButtonIcon),p(),g(" ",i.sampleCodeButtonLabel),p(),m("ngClass",B(4,ve,i.hideSampleCodeTabs)))},dependencies:[T,k,v,C,pe],encapsulation:2})}return o})();function ke(o,Se){if(o&1){let r=V();n(0,"div",0),l(1,"po-avatar",2),n(2,"div",3)(3,"span",4),e(4),t(),n(5,"span",5),e(6),t(),n(7,"span",5),e(8),t()()(),n(9,"div",0)(10,"po-button",6),s("p-click",function(){b(r);let i=M();return E(i.notification("added","success"))}),t(),n(11,"po-button",7),s("p-click",function(){b(r);let i=M();return E(i.notification("ignored","warning"))}),t(),n(12,"po-button",8),s("p-click",function(){b(r);let i=M();return E(i.notification("blocked","information"))}),t()()}if(o&2){let r=M();p(),m("p-src",r.userAvatar),p(3),g(" ",r.currentFriend.name," "),p(2),g(" ",r.currentFriend.mutualFriends," mutual friends "),p(2),g(" Resides in ",r.currentFriend.reside," ")}}function ye(o,Se){o&1&&(n(0,"div",0)(1,"span",9),e(2,"Congratulations TOTVS, no more requests!"),t()())}var me=(()=>{class o{poNotification=A(te);currentFriend;userAvatar="https://lorempixel.com/144/144/";newFriends=[{name:"Mr. Dev PO",mutualFriends:"7",reside:"Mountain View, CA"},{name:"Mr. AI PO",mutualFriends:"99+",reside:"New York City, NY"},{name:"Mr. UX PO",mutualFriends:"14",reside:"Los Angeles, CA"}];indexFriend=0;ngOnInit(){this.setCurrentFriend(0)}notification(r,a){this.poNotification[a](`User ${r} successfully!`),this.indexFriend++,this.setCurrentFriend(this.indexFriend)}setCurrentFriend(r){this.currentFriend=this.newFriends[r]}static \u0275fac=function(a){return new(a||o)};static \u0275cmp=c({type:o,selectors:[["sample-po-button-social-network"]],standalone:!1,decls:4,vars:1,consts:[[1,"po-row"],["p-title","Friend Request",1,"po-lg-6"],["p-size","lg",1,"po-md-4",3,"p-src"],[1,"po-md-8"],[1,"po-sm-12","po-font-subtitle"],[1,"po-sm-12","po-font-text"],["p-icon","fa fa-check-circle","p-label","Confirm",1,"po-md-4",3,"p-click"],["p-icon","fa fa-eye-slash","p-label","Ignore",1,"po-md-4",3,"p-click"],["p-icon","fa fa-ban","p-label","Block",1,"po-md-4",3,"p-click"],[1,"po-lg-8","po-font-subtitle"]],template:function(a,i){a&1&&(n(0,"div",0)(1,"po-widget",1),W(2,ke,13,4)(3,ye,3,0,"div",0),t()()),a&2&&(p(2),R(i.currentFriend?2:3))},dependencies:[J,D,oe],encapsulation:2})}return o})();var we=o=>({"docs-sample-code-tabs":o}),ce=(()=>{class o{hideSampleCodeTabs=!0;sampleCodeButtonLabel="Talk is cheap, show me the code!";sampleCodeButtonIcon="an an-plus";toggleSampleCodeTabs(){this.hideSampleCodeTabs=!this.hideSampleCodeTabs,this.sampleCodeButtonLabel=this.hideSampleCodeTabs?"Talk is cheap, show me the code!":"Okay, hide the code",this.sampleCodeButtonIcon=this.hideSampleCodeTabs?"an an-plus":"an an-minus"}static \u0275fac=function(a){return new(a||o)};static \u0275cmp=c({type:o,selectors:[["sample-po-button-social-network-view"]],standalone:!1,decls:24,vars:6,consts:[[1,"sample-blockquote"],[1,"sample-title","po-font-text-large-bold"],[1,"show-me-the-code",3,"click"],[3,"ngClass"],["p-size","2"],["p-label","HTML","p-active",""],[1,"doc-label-path"],["appCodeHighlight","",1,"html"],["p-label","TS"],["appCodeHighlight","",1,"typescript"],[1,"docs-sample-container"]],template:function(a,i){a&1&&(l(0,"br"),n(1,"blockquote",0)(2,"label",1),e(3,"PO Button Social Network"),t(),n(4,"a",2),s("click",function(){return i.toggleSampleCodeTabs()}),l(5,"span"),e(6),t()(),n(7,"div",3)(8,"po-tabs",4)(9,"po-tab",5)(10,"div")(11,"label",6),e(12,"sample-po-button-social-network/sample-po-button-social-network.component.html"),t(),n(13,"pre",7),e(14,`<div class="po-row">
...
Para mais detalhes, consulte a documenta\xE7\xE3o do `),n(649,"a",30),e(650,"po-theme"),t(),e(651,"."),t()()()(),n(652,"tr",16)(653,"td",17)(654,"div",18)(655,"span",19),e(656," p-tabindex"),l(657,"br"),t()()(),n(658,"td",20)(659,"code",31),e(660,"number "),t(),n(661,"code",21),e(662," string"),t()(),n(663,"td",22),e(664,"-"),t(),n(665,"td",23)(666,"em")(667,"strong"),e(668,"(opcional)"),t()(),n(669,"p"),e(670,"Define o "),n(671,"code"),e(672,"tabindex"),t(),e(673," do elemento "),n(674,"code"),e(675,"<button>"),t(),e(676," nativo interno."),t(),n(677,"p"),e(678,"Use "),n(679,"code"),e(680,'[tabindex]="-1"'),t(),e(681," para remover o bot\xE3o da ordem de foco do teclado."),t()()(),n(682,"tr",16)(683,"td",17)(684,"div",18)(685,"span",19),e(686," p-type"),l(687,"br"),t()()(),n(688,"td",20)(689,"code",32),e(690,"PoButtonType"),t()(),n(691,"td",22)(692,"p")(693,"code"),e(694,"PoButtonType.Button"),t()()(),n(695,"td",23)(696,"em")(697,"strong"),e(698,"(opcional)"),t()(),n(699,"p"),e(700,"Define o tipo do bot\xE3o."),t()()()(),n(701,"h3",12),e(702,"M\xE9todos"),t(),n(703,"table",33)(704,"tr",16)(705,"th",34)(706,"div",18)(707,"h4")(708,"span",19),e(709," focus "),t()()()()(),n(710,"tr",23)(711,"td",23)(712,"p"),e(713,"Fun\xE7\xE3o que atribui foco ao componente."),t(),n(714,"p"),e(715,"Para utiliz\xE1-la \xE9 necess\xE1rio ter a inst\xE2ncia do componente no DOM, podendo ser utilizado o ViewChild da seguinte forma:"),t(),n(716,"pre")(717,"code"),e(718,`import { PoButtonComponent } from '@po-ui/ng-components';
...
`),t()()()()(),l(719,"br"),n(720,"h3"),e(721,"Enums"),t(),n(722,"h4",4)(723,"code",5),e(724,"PoButtonKind"),t()(),n(725,"div",2)(726,"p"),e(727,"Estilos dispon\xEDveis do button."),t()(),n(728,"h4",12),e(729,"Propriedades"),t(),n(730,"table",13)(731,"tr",14)(732,"th",15),e(733,"Nome"),t(),n(734,"th",15),e(735,"Descri\xE7\xE3o"),t()(),n(736,"tr",16)(737,"td",17)(738,"div",18)(739,"span",19),e(740," primary"),l(741,"br"),t()()(),n(742,"td",23)(743,"p"),e(744,"Estilo prim\xE1rio, usado para a\xE7\xF5es principais que requerem maior destaque."),t()()(),n(745,"tr",16)(746,"td",17)(747,"div",18)(748,"span",19),e(749," secondary"),l(750,"br"),t()()(),n(751,"td",23)(752,"p"),e(753,"Estilo secund\xE1rio, usado como padr\xE3o, para a\xE7\xF5es comuns."),t()()(),n(754,"tr",16)(755,"td",17)(756,"div",18)(757,"span",19),e(758," tertiary"),l(759,"br"),t()()(),n(760,"td",23)(761,"p"),e(762,"Estilo terci\xE1rio, ideal para a\xE7\xF5es menos importantes, sem fundo preenchido."),t()()()(),n(763,"h4",4)(764,"code",5),e(765,"PoButtonType"),t()(),n(766,"div",2)(767,"p"),e(768,"Enumera\xE7\xE3o que define os tipos poss\xEDveis para o "),n(769,"code"),e(770,"PoButtonComponent"),t(),e(771,`. Estes tipos est\xE3o relacionados ao comportamento
do bot\xE3o quando utilizado dentro de um formul\xE1rio HTML.`),t()(),n(772,"h4",12),e(773,"Propriedades"),t(),n(774,"table",13)(775,"tr",14)(776,"th",15),e(777,"Nome"),t(),n(778,"th",15),e(779,"Descri\xE7\xE3o"),t()(),n(780,"tr",16)(781,"td",17)(782,"div",18)(783,"span",19),e(784," Submit"),l(785,"br"),t()()(),n(786,"td",23)(787,"p"),e(788,"Define o bot\xE3o como do tipo "),n(789,"code"),e(790,"submit"),t(),e(791,`. Quando clicado, o formul\xE1rio \xE9 enviado automaticamente,
disparando o evento `),n(792,"code"),e(793,"submit"),t(),e(794,"."),t()()(),n(795,"tr",16)(796,"td",17)(797,"div",18)(798,"span",19),e(799," Button"),l(800,"br"),t()()(),n(801,"td",23)(802,"p"),e(803,"Define o bot\xE3o como do tipo "),n(804,"code"),e(805,"button"),t(),e(806,`. Este tipo de bot\xE3o n\xE3o possui comportamento padr\xE3o associado
e \xE9 utilizado principalmente para a\xE7\xF5es program\xE1ticas como cliques e disparos de eventos customizados.`),t()()(),n(807,"tr",16)(808,"td",17)(809,"div",18)(810,"span",19),e(811," Reset"),l(812,"br"),t()()(),n(813,"td",23)(814,"p"),e(815,"Define o bot\xE3o como do tipo "),n(816,"code"),e(817,"reset"),t(),e(818,`. Quando clicado, redefine os campos do formul\xE1rio ao qual pertence
para seus valores iniciais.`),t()()()()())},dependencies:[k],encapsulation:2})}return o})();var be=(()=>{class o{route;router;sub;hidePoWebSample=!0;samplesLength=3;activeTab="doc";actions=[{label:"Documenta\xE7\xE3o",action:this.goBack.bind(this),icon:"an an-file-text"},{label:"Colabore",action:this.improveDocs.bind(this)}];constructor(r,a){this.route=r,this.router=a}goBack(){this.router.navigate(["documentation"])}improveDocs(){this.router.navigate(["guides/development-flow"])}ngOnInit(){this.sub=this.route.queryParams.subscribe(r=>{let a=r.view;this.activeTab=a||"doc",this.hidePoWebSample=this.samplesLength===0})}changeTab(r){this.router.navigate([],{queryParams:{view:r},queryParamsHandling:"merge"}),this.activeTab=r}ngOnDestroy(){this.sub.unsubscribe()}static \u0275fac=function(a){return new(a||o)(N(Q),N(Y))};static \u0275cmp=c({type:o,selectors:[["ng-component"]],standalone:!1,decls:8,vars:4,consts:[["p-title","Button",3,"p-actions"],["p-size","1"],["p-label","Documenta\xE7\xE3o",3,"p-click","p-active"],["p-label","Exemplos",3,"p-click","p-hide","p-active"]],template:function(a,i){a&1&&(n(0,"po-page-default",0)(1,"po-tabs",1)(2,"po-tab",2),s("p-click",function(){return i.changeTab("doc")}),l(3,"sample-po-button-doc"),t(),n(4,"po-tab",3),s("p-click",function(){return i.changeTab("web")}),l(5,"sample-po-button-basic-view")(6,"sample-po-button-labs-view")(7,"sample-po-button-social-network-view"),t()()()),a&2&&(m("p-actions",i.actions),p(2),m("p-active",i.activeTab==="doc"),p(2),m("p-hide",i.hidePoWebSample)("p-active",i.activeTab==="web"))},dependencies:[ie,v,C,de,se,ce,ue],encapsulation:2})}return o})();var Te=[{path:"",component:be}],Ee=(()=>{class o{static \u0275fac=function(a){return new(a||o)};static \u0275mod=L({type:o});static \u0275inj=z({imports:[q.forChild(Te),q]})}return o})();var rt=(()=>{class o{static \u0275fac=function(a){return new(a||o)};static \u0275mod=L({type:o});static \u0275inj=z({imports:[ae,Ee]})}return o})();export{rt as DocPoButtonModule};
